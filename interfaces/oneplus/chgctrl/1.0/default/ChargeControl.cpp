...
/*
 * If the default node is not compatible, bake this HAL into your
 * device tree and change the following macros.
 */
...
namespace vendor::oneplus::chgctrl::implementation {
...
// Methods from ::vendor::oneplus::chgctrl::V1_0::IChargeControl follow.
